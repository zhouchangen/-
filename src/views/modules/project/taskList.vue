    ...
    <div class="headerSearch">
      <el-form :inline="true" :model="dataForm">
        ...
        <el-col :span="10">
            ...
            value-format="yyyy-MM-dd"
            :picker-options= 'pickerOption'
            @change="changeBeginTime"></el-date-picker>
        </el-col>
        ...
        <el-form-item>
          <el-button type="primary" @click="addTask(1,pGuid,vGuid)">新建任务</el-button>
        </el-form-item>
      </el-form>
    </div>
...
export default {
  ...
  methods: {
  changeBeginTime(){//时间change事件
      if(this.dataForm.startTime&&this.dataForm.endTime){
        if(new Date(this.dataForm.endTime.toString())<new Date(this.dataForm.startTime.toString())){
    ...
    changeLevel(selVal,row,num) {
      // this.$refs.wtf.click();
      console.log(this.strForm.level)
    ...
    goDetail(id) {
      this.$router.push({ name: "work-tkdetail", params: { id: id} });
    },
    addTask(num,pGuid,vGuid) {
      this.$router.push({name: 'work-add', params: {type: num,pGuid: this.pGuid, vGuid: this.vGuid,}})
    },
