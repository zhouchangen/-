  ...
  <div id="fileApply" ref="fileApply">
    <div class="headerSearchInfo">
      <div class="topContent">
        <el-form :inline="true" :model="filesSearchForm">
        <el-form-item label="文件名：">
          <el-input v-model="filesSearchForm.name" maxlength="20" placeholder="请输入标题名称"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <div title="发送图片" style="position: relative; top:26px;right:20px;">
                <el-upload
                  :http-request="Upload"
  ...
  export default {
    ...
    methods: {
      ...
      getDataList (num) {
        ...
        this.$http({
          url: this.$http.adornUrl('/project/files/list?principal=' + 2 +'&parentId=' +this.vGuid),
          method: 'get',
